...
namespace personalBlogSolution.Data.Migrations
{
    ...
    [Migration("20210317151540_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("personalBlogSolution.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "d4a7cb7c-4193-4e35-a195-d7943d56fe2e",
            ...
            modelBuilder.Entity("personalBlogSolution.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a73ef181-5a90-4967-8574-953197f9d016",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEGUrWftLWVz5IOz6vQizJfEqQotFErTLglAwXkMAVYEf/63RXsAcIeyO90iPOtOLsQ==",
            ...
            modelBuilder.Entity("personalBlogSolution.Data.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 17, 22, 15, 39, 327, DateTimeKind.Local).AddTicks(7270));

                    b.Property<DateTime>("DateModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 17, 22, 15, 39, 338, DateTimeKind.Local).AddTicks(6570));
            ...
            modelBuilder.Entity("personalBlogSolution.Data.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 17, 22, 15, 39, 345, DateTimeKind.Local).AddTicks(3960));

                    b.Property<DateTime>("DateModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 17, 22, 15, 39, 345, DateTimeKind.Local).AddTicks(4280));
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2021, 3, 17, 22, 15, 39, 385, DateTimeKind.Local).AddTicks(8230),
                            DateModified = new DateTime(2021, 3, 17, 22, 15, 39, 385, DateTimeKind.Local).AddTicks(8690),
                        ...
                        {
                            Id = 2,
                            DateCreated = new DateTime(2021, 3, 17, 22, 15, 39, 385, DateTimeKind.Local).AddTicks(9960),
                            DateModified = new DateTime(2021, 3, 17, 22, 15, 39, 385, DateTimeKind.Local).AddTicks(9970),
                        ...
                        {
                            Id = 3,
                            DateCreated = new DateTime(2021, 3, 17, 22, 15, 39, 385, DateTimeKind.Local).AddTicks(9970),
                            DateModified = new DateTime(2021, 3, 17, 22, 15, 39, 385, DateTimeKind.Local).AddTicks(9970),
            ...
            modelBuilder.Entity("personalBlogSolution.Data.Entities.PostImage", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 17, 22, 15, 39, 350, DateTimeKind.Local).AddTicks(1100));
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Caption = "Bitcoin",
                            DateCreated = new DateTime(2021, 3, 17, 22, 15, 39, 386, DateTimeKind.Local).AddTicks(3360),
                            FileSize = 0L,
                        ...
                        new
                        {
                            Id = 2,
                            Caption = "Object",
                            DateCreated = new DateTime(2021, 3, 17, 22, 15, 39, 386, DateTimeKind.Local).AddTicks(4520),
                            FileSize = 0L,
            ...
            modelBuilder.Entity("personalBlogSolution.Data.Entities.Post", b =>
                {
                    b.HasOne("personalBlogSolution.Data.Entities.AppUser", "AppUser")
                        .WithMany("Posts")
